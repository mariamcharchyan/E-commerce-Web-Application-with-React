import '../Novelties/Novelties.css'
import './ProductLeaders.css'
...
export default function ProductLeaders(){
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/bestSellingProducts`, {
            method: 'Get',
            headers: {
              'Content-Type': 'application/json',
    ...
    return(
        ...
        <div className='novelties'>
            <div className='noveltiesTitle'>
                <h2> ______________________________________________ Product Leaders ________________________________________________ </h2>
            </div>
                ...
                {productLeadersData.map((toyData) => (
                    <SwiperSlide className='slide' key={toyData.id}>
                        <div className='slideBoxToy'>
                            ...
                            <div className="starIcon" ><img src= {star} className='crownIconImg' alt=""/></div>
                        </div>
                    </SwiperSlide>
                ))}
            </Swiper>
